...
const findLastMessageNode = async (chatNode, keynodes) => {
...
const findCurrentEdge = async (chatNode, messageNode) => {
...
const findPreviousMessageNode = async (chatNode, currentEdge) => {
...
const findPreviousEdge = async (chatNode, keynodes, currrentMessageNode) => {
...
export const getInfoMessage = async (messagesNode, keynodes) => {
...
const checkRrel1 = async (keynodes, chatNode, messageNode) => {
    const template = new ScTemplate();
    template.tripleWithRelation(
        chatNode,
        ScType.EdgeAccessVarPosPerm,
...
export const searchChatMessages = async (chatNode, amount, lastMessageScAddr) => {
